document.addEventListener('DOMContentLoaded', function() {
    ...
    todoForm.addEventListener('submit', function(e) {
      ...
      if (newTask !== '' && newDescription !== '' && newEventDate !== '' && isValidDate(newEventDate)) {
        ...
        errorMessage.textContent = 'Please fill in all required fields with valid data (including the date in YYYY-MM-DD format)!';
      }
    });
    ...
    taskList.addEventListener('click', function(e) {
      ...
      if (e.target.classList.contains('edit-date-btn')) {
        let updatedDate = prompt('Edit date (YYYY-MM-DD format):', tasks[index].date);
        if (updatedDate !== null) {
